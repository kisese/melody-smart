 ...
 */
public class Finger4PatternActivity  extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        i = new Intent(Finger4PatternActivity.this, SendSaveActivity.class);
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("finger_3_color", finger_3_color);
                i.putExtra("finger_3_pattern", finger_3_pattern);
                startActivity(i);
                    } else
        ...
        patterns_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (patterns_group.getCheckedRadioButtonId() == R.id.pattern_strobe) {
                    i.putExtra("finger_4_pattern", "P1");
                    ...
                    i.putExtra("finger_4_pattern", "P2");
                    ...
                    i.putExtra("finger_4_pattern", "P3");
                    ...
                    i.putExtra("finger_4_pattern", "P4");
                    ...
                    i.putExtra("finger_4_pattern", "P5");
