 ...
 */
public class Finger2PatternActivity extends ActionBarActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        i = new Intent(Finger2PatternActivity.this, Finger3PatternActivity.class);
        ...
        mToolbar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i3 = new Intent(Finger2PatternActivity.this, MainActivity.class);
                startActivity(i3);
            }
        });
        ...
        patterns_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (patterns_group.getCheckedRadioButtonId() == R.id.pattern_strobe) {
                    i.putExtra("finger_2_pattern", "P1");
                    ...
                    i.putExtra("finger_2_pattern", "P2");
                    ...
                    i.putExtra("finger_2_pattern", "P3");
                    ...
                    i.putExtra("finger_2_pattern", "P4");
                    ...
                    i.putExtra("finger_2_pattern", "P5");
